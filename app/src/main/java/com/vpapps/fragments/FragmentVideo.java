...
import com.vpapps.adapter.AdapterNewsByVideo;
...
//                ft.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
    ...
    private void loadNewsData() {
        if (methods.isNetworkAvailable()) {
            ...
            }, methods.getAPIRequest(Constant.METHOD_VIDEO_NEWS, page, "", "", "", "", sharedPref.getCat(), "", "", "", "", "", "", "", null));
    ...
    public void setAdapter() {
        if (!isScroll) {
            myAdapter = new AdapterNewsByVideo(getActivity(), arrayList);
